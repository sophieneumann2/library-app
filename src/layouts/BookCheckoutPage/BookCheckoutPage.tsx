...
export const BookCheckoutPage = () => {
    ...
    useEffect(() => {
        const fetchBookReviews = async () => {
            const reviewUrl: string = `${process.env.REACT_APP_API}/reviews/search/findReviewsByBookId?bookId=${bookId}`;
    ...
    return (
        <div>
            <div className={"container d-none d-lg-block"}>
                {displayError &&
                    <div className={"alert alert-danger mt-3"} role={"alert"}>Please pay outstanding fees and/or return
                        late book(s).</div>}
